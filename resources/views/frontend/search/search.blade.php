...
@section('content')
					<div class="features_items"><!--features_items-->
						...
						<form method="POST" action="{{route('searchLike')}}" class="form-container">
						    @csrf

						    <input type="text" id="name" placeholder="Name" name="name">
						    <select id="price" name="price">
						        <option value="0-200000">Choose Price</option>
						        <option value="1000-20000">1000-20000</option>
						        <option value="20000-30000">20000-30000</option>
						        <option value="30000-50000">30000-50000</option>
						        <option value="50000-200000">50000-max</option>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">											
											<img src="{{ asset('/upload/product/'.str_replace(' ', '_', $product['images'][2]))}}" alt="no img" />											
											<h2>{{$product['price']}}</h2>
											<p>{{$product['name']}}</p>
...
<style>
    ...
    .form-container select {
        flex: 2; /* Chia đều chiều rộng giữa các input/select */
