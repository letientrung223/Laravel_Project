							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">											
											<img src="{{ asset('/upload/product/'. str_replace(' ', '_', $product['images'][2])) }}" alt="" />
										...
										<div class="product-overlay">
											...
											<div class="overlay-content">
												...
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
								 				<a href="{{ route('product.detail', ['id' => $product['id']]) }}" class="btn btn-default add-to-cart"><i class="fa fa-info" aria-hidden="true"></i></i> Go to Detail</a>
...
<script>
 ...
 $(document).ready(function() {
        ...
        $('.add-to-cart').on('click', function () {
            var productId = $(this).closest('.overlay-content').find('.id_product').attr('id');
