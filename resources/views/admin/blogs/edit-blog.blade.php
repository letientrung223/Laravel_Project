...
@if(session('success'))
    ...
    <h3> Cập nhật Blog thành công</h3>
    </div>
@endif 
@if($errors->any())
                            ...
                            <div class="card-body">
                                ...
                                enctype="multipart/form-data" class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="{{$blog->title}}"   name= "title" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="txtContent"  class='form-control' id='editor'>{{ $blog->content }}</textarea>
                                        </div>
                                    </div>
